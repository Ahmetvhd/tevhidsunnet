                ...
                <div className="container px-4 md:px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        <Card className="group relative overflow-hidden border-none shadow-lg bg-card hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 ring-1 ring-primary/20 flex flex-col">
                            ...
                            {/* App Screenshots Background Collage & Amber Tint */}
                            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                                {/* Amber Top Gradient for Warmth */}
                                <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-primary/10 to-transparent z-10" />

                                {/* Screenshot 1 - Top Left */}
                                <div className="absolute -top-10 -left-10 w-48 h-80 transform -rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://play-lh.googleusercontent.com/hpPwYMu_8bYZEVYqiCfOjn-w_OnD5hrWQDwEX0DakiFMEoJfw_X_ug0uNpA_J_7S8qpwNrpCuzVNqUg_MWKD=w1052-h592-rw"
                                        alt="Screenshot 1"
                                        fill
                                ...
                                {/* Screenshot 2 - Center Right */}
                                <div className="absolute top-20 -right-16 w-56 h-96 transform rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://play-lh.googleusercontent.com/7qiWoXi0yEX9OY-Iz0WbwA4L7_fLQ3RoK-9BIMpClQq-R_-rRPzpyhAWdiB18P16nK0pO5cHq4ciuk53hvGB2w=w1052-h592-rw"
                                        alt="Screenshot 2"
                                        fill
                                        className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                                        unoptimized
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-card/60 via-card/80 to-card z-0" />
                            </div>
                        ...
                        <Card className="group relative overflow-hidden border-none shadow-lg bg-card hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 ring-1 ring-primary/20 flex flex-col">
                            ...
                            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                                ...
                                <div className="absolute -top-10 -left-10 w-48 h-80 transform -rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://play-lh.googleusercontent.com/z1EOeeMgGuQvTBnYNHTLwzWWQF-VUTuaOP1757y-J33UWNT9_w1kb51kRxgV16T318Y=w5120-h2880-rw"
                                        alt="Kıblegâh Screenshot 1"
                                        fill
                                        className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                                        unoptimized
                                    />
                                ...
                                <div className="absolute top-20 -right-16 w-56 h-96 transform rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://play-lh.googleusercontent.com/YnHT88cjlFza7KSyRBUbvLiTD1uS8Dti6YZR2-d5wqVtbh8z0jNXrydDe-GmwtNDMw=w5120-h2880-rw"
                                        alt="Kıblegâh Screenshot 2"
                                        fill
                                        className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                                        unoptimized
                                    />
                        ...
                        <Card className="group relative overflow-hidden border-none shadow-lg bg-card hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 ring-1 ring-primary/20 flex flex-col">
                            ...
                            <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                                ...
                                <div className="absolute -top-10 -left-10 w-48 h-80 transform -rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://play-lh.googleusercontent.com/3oMoZz5YAYE2LwBq6-SytgYp1t890E4F-vyc61ZomBHedAnx4JNODDaqsf1EAvhbFOw=w1052-h592-rw"
                                        alt="Anlat Bakalım Screenshot 1"
                                        fill
                                        className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                                        unoptimized
                                    />
                                ...
                                <div className="absolute top-20 -right-16 w-56 h-96 transform rotate-12 opacity-[0.50] group-hover:opacity-[0.25] transition-opacity duration-500">
                                    <Image
                                        src="https://is1-ssl.mzstatic.com/image/thumb/PurpleSource211/v4/27/b9/88/27b9884d-7ef7-b5d7-c6df-4a80c1022471/Simulator_Screenshot_-_iPad_Pro_13-inch__U0028M4_U0029_-_2025-03-26_at_17.12.24.png/960x1280bb.webp"
                                        alt="Anlat Bakalım Screenshot 2"
                                        fill
                                        className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
                                        unoptimized
                                    />
                ...
                <div className="container px-4 md:px-6">
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <Card className="group relative h-full overflow-hidden border border-border/40 bg-card shadow-md hover:shadow-2xl hover:-translate-y-1 hover:border-primary/20 transition-all duration-500">
                                {/* Arka Plan Görseli */}
                                <div className="absolute inset-0 z-0">
                                    <Image
                                        src="/images/tevhiddersleriarkaplan.jpg"
                                ...
                                <CardContent className="relative z-10 p-5 flex flex-col items-center text-center">
                                    {/* Profil Fotoğrafı */}
                                    <div className="relative mb-3 mt-1">
                                        ...
                                        <div className="relative w-16 h-16 rounded-full overflow-hidden border-4 border-background shadow-xl ring-1 ring-border group-hover:ring-primary/50 transition-all duration-300">
                                            <Image
                                                src="/images/tevhiddersleri.jpg"
                                                alt="Tevhid Dersleri"
                                                fill
                                    ...
                                    {/* Başlık */}
                                    <h3 className="text-base font-bold tracking-tight group-hover:text-primary transition-colors duration-300 mb-3">
                                        Tevhid Dersleri
                                    </h3>
                                    ...
                                    <div className="grid grid-cols-4 gap-1.5 mb-3 w-full max-w-[200px]">
                                        {/* X */}
                                        <Link href="https://x.com/tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* Instagram */}
                                        <Link href="https://www.instagram.com/tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-gradient-to-tr hover:from-[#f09433]/20 hover:via-[#dc2743]/20 hover:to-[#bc1888]/20 hover:border-[#dc2743]/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-[#dc2743] group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* YouTube */}
                                        <Link href="https://www.youtube.com/@tevhiddersleri_" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-red-500/10 hover:border-red-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-red-600 group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* Facebook */}
                                        <Link href="https://www.facebook.com/tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-blue-500/10 hover:border-blue-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-blue-600 group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* Telegram */}
                                        <Link href="https://t.me/tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-sky-500/10 hover:border-sky-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-sky-500 group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* WhatsApp */}
                                        <Link href="https://wa.me" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-green-500/10 hover:border-green-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-green-600 group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* TikTok */}
                                        <Link href="https://www.tiktok.com/@tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                        ...
                                        {/* Dailymotion */}
                                        <Link href="https://www.dailymotion.com/tevhiddersleri" target="_blank" className="group/icon">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-blue-600/10 hover:border-blue-600/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-blue-600 group-hover/icon:scale-110 transition-all duration-300">
                            ...
                            <Card className="group relative h-full overflow-hidden border border-border/40 bg-card shadow-md hover:shadow-2xl hover:-translate-y-1 hover:border-primary/20 active:scale-[0.99] transition-all duration-500 touch-manipulation">
                                {/* Arka Plan Görseli */}
                                <div className="absolute inset-0 z-0">
                                    <Image
                                        src="/images/halisbayancuk_bg.png"
                                ...
                                <CardContent className="relative z-10 p-5 flex flex-col items-center text-center">
                                    ...
                                    <div className="grid grid-cols-4 gap-1.5 mb-3 w-full max-w-[200px]">
                                        {/* X */}
                                        <Link href="https://x.com/halisbayancuk" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                                </svg>
                                        ...
                                        {/* Instagram */}
                                        <Link href="https://www.instagram.com/halisbayancuk" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-gradient-to-tr hover:from-[#f09433]/20 hover:via-[#dc2743]/20 hover:to-[#bc1888]/20 hover:border-[#dc2743]/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-[#dc2743] group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" />
                                                </svg>
                                        ...
                                        {/* YouTube */}
                                        <Link href="https://www.youtube.com/@HalisBayancuk_Hoca" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-red-500/10 hover:border-red-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-red-600 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                                                </svg>
                                        ...
                                        {/* Facebook */}
                                        <Link href="https://www.facebook.com/halisbayancuk" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-blue-500/10 hover:border-blue-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-blue-600 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                        ...
                                        {/* Telegram */}
                                        <Link href="https://t.me/halisbayancuk" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-sky-500/10 hover:border-sky-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-sky-500 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M23.1117 4.49449C23.4296 2.94472 21.9074 1.65683 20.4317 2.227L2.3425 9.21601C0.694517 9.85273 0.621087 12.1572 2.22518 12.8975L6.1645 14.7157L8.03849 21.2746C8.13583 21.6153 8.40618 21.8791 8.74917 21.968C9.09216 22.0568 9.45658 21.9576 9.70712 21.707L12.5938 18.8203L16.6375 21.8531C17.8113 22.7334 19.5019 22.0922 19.7967 20.6549L23.1117 4.49449ZM3.0633 11.0816L21.1525 4.0926L17.8375 20.2531L13.1 16.6999C12.7019 16.4013 12.1448 16.4409 11.7929 16.7928L10.5565 18.0292L10.928 15.9861L18.2071 8.70703C18.5614 8.35278 18.5988 7.79106 18.2947 7.39293C17.9906 6.99479 17.4389 6.88312 17.0039 7.13168L6.95124 12.876L3.0633 11.0816ZM8.17695 14.4791L8.78333 16.6015L9.01614 15.321C9.05253 15.1209 9.14908 14.9366 9.29291 14.7928L11.5128 12.573L8.17695 14.4791Z" />
                                                </svg>
                                        ...
                                        {/* WhatsApp */}
                                        <Link href="https://wa.me" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-green-500/10 hover:border-green-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-green-600 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z" />
                                                </svg>
                                        ...
                                        {/* TikTok */}
                                        <Link href="https://www.tiktok.com/@halisbayancuk" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.65-1.58-1.11-.27-.26-.53-.55-.78-.85v10.51c-.01 1.63-.58 3.24-1.62 4.54-1.04 1.3-2.58 2.08-4.23 2.15-2.1.09-4.2-.82-5.46-2.5-1.35-1.81-1.39-4.32-.1-6.17 1.17-1.67 3.16-2.6 5.17-2.45v3.91c-.57-.1-1.18.15-1.55.59-.44.5-.42 1.25.03 1.73.43.46 1.16.51 1.65.11.45-.37.71-.94.69-1.53v-13.5a20.16 20.16 0 0 1 4.2-1.28c-1.35-.45-2.06-1.92-2.12-3.69Z" />
                                                </svg>
                            ...
                            <Card className="group relative h-full overflow-hidden border border-border/40 bg-card shadow-md hover:shadow-2xl hover:-translate-y-1 hover:border-primary/20 active:scale-[0.99] transition-all duration-500 touch-manipulation">
                                ...
                                <CardContent className="relative z-10 p-5 flex flex-col items-center text-center">
                                    ...
                                    <div className="grid grid-cols-4 gap-1.5 mb-3 w-full max-w-[200px]">
                                        {/* X */}
                                        <Link href="https://x.com/bizimdunyamiz" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                                </svg>
                                        ...
                                        {/* Instagram */}
                                        <Link href="https://www.instagram.com/bizimdunyamiz" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-gradient-to-tr hover:from-[#f09433]/20 hover:via-[#dc2743]/20 hover:to-[#bc1888]/20 hover:border-[#dc2743]/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-[#dc2743] group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" />
                                                </svg>
                                        ...
                                        {/* YouTube */}
                                        <Link href="https://www.youtube.com/@BizimDunyamiz" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-red-500/10 hover:border-red-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-red-600 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                                                </svg>
                                        ...
                                        {/* Facebook */}
                                        <Link href="https://www.facebook.com/bizimdunyamiz" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-blue-500/10 hover:border-blue-500/30 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-blue-600 group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                        ...
                                        {/* TikTok */}
                                        <Link href="https://www.tiktok.com/@bizimdunyamiz" target="_blank" className="group/icon active:scale-95 transition-transform">
                                            <div className="w-10 h-10 rounded-lg bg-muted/60 border border-border/40 hover:bg-black/10 hover:border-black/20 flex items-center justify-center transition-all duration-300 hover:shadow-md">
                                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-foreground/80 group-hover/icon:text-black group-hover/icon:scale-110 transition-all duration-300">
                                                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.65-1.58-1.11-.27-.26-.53-.55-.78-.85v10.51c-.01 1.63-.58 3.24-1.62 4.54-1.04 1.3-2.58 2.08-4.23 2.15-2.1.09-4.2-.82-5.46-2.5-1.35-1.81-1.39-4.32-.1-6.17 1.17-1.67 3.16-2.6 5.17-2.45v3.91c-.57-.1-1.18.15-1.55.59-.44.5-.42 1.25.03 1.73.43.46 1.16.51 1.65.11.45-.37.71-.94.69-1.53v-13.5a20.16 20.16 0 0 1 4.2-1.28c-1.35-.45-2.06-1.92-2.12-3.69Z" />
                                                </svg>
